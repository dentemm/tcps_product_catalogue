...
$(function() {
	...
	$(window).resize(function() {
		delay(function() {
				var gallery_images = $('#slide-P img');
				...
				var gallery_width = $('#slide-P img').width() * $('#slide-3 img').length;
				gallery_width /= 2;
				if ( $('#slide-P img').length % 2 != 0 ) {
					gallery_width += $('#slide-P img').width();
				}
				
				$('#slide-P .row').css('width', gallery_width );
				
				var left_pos = $('#slide-P .row').width() - $('body').width();
				left_pos /= -2;
				
				$('#slide-P .row').css('left', left_pos);
